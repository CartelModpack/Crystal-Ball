...
const wasm_instance = await WebAssembly.instantiate(readFileSync("./node_modules/json_typegen_wasm/json_typegen_wasm_bg.wasm"));
const wasm = wasm_instance.instance.exports;
